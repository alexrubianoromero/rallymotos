 ...
 */
$sql_ruta_imagen = "select ruta_imagen,nombre from $tabla10 where id_empresa = '71'  ";  
...
<table width="95%" border="1">
  ...
  <?php
    ...
    $subtotal =  muestre_items_nuevo($datos[0]['id_orden'],$tabla15,$conexion,'71',$datos['0']['resolucion']); 
